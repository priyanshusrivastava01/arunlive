 ...
 * Shared UI
 *********************************/
function PrimaryButton({ label = "Register Now At ₹7999/- Only", className = "", ...props }) {
  const classes =
  ...
  return <RegisterButton amount={props.amount ?? 7999} className={classes} label={label} />;
}
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md text-center border border-yellow-300">
        ...
        <p className="text-zinc-700 mb-6">
          Your ₹7999 Guidance session is still available. Don't miss this chance!
        </p>
    ...
    <section className="py-20 px-6 bg-white text-black" data-testid="coach-intro">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-yellow-200">
          <h2 className="text-2xl font-bold mb-4 text-yellow-700">What Happens In Your 1-on-1 Session?</h2>
      ...
      <div className="max-w-3xl mx-auto mt-12 text-center">
        ...
        <h2 className="text-4xl font-bold text-yellow-700">Arunn Guptaa</h2>
    ...
    <section className="py-8 bg-white text-black px-6 text-center" id="pricing">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-yellow-300 p-6 relative">
        ...
        <div className="flex justify-center items-end gap-4 mt-6">
          <span className="diag-strike text-2xl text-zinc-500">₹39999</span>
          <span className="text-6xl font-extrabold text-yellow-600">₹7999</span>
        </div>

        {/* Smart Explanation – short & classy */}
        <p className="mt-4 text-zinc-700 text-lg font-medium max-w-lg mx-auto">
          Start your session for <span className="font-bold text-yellow-700">just ₹7999, Today.</span> If the session genuinely helps you, you pay the remaining <span className="font-bold text-yellow-700">₹32000 after the session.</span>
        </p>
...
function CoachStats() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl font-bold mb-2 text-black">Meet Your Coach</h2>
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        />
        <h3 className="text-2xl font-bold mt-4 text-yellow-700">Arunn Guptaa</h3>
    ...
    >
      <div className="relative max-w-4xl mx-auto bg-white p-10 rounded-3xl border border-yellow-200 shadow-xl pt-20">
        ...
        <p className="text-center text-zinc-600 max-w-2xl mx-auto mb-8">
          Join today for just ₹7999 and experience a powerful business-growth
...
function FAQ() {
  const list = [
    ...
    { q: "Is ₹7999 the final price?", a: "Yes, limited-time offer for new clients only. However you can pay Rs 32000 if you are 100% satisfied with the consultancy, just after the session." },
  ...
  return (
    <section className="py-20 bg-white px-6 text-black border-t border-yellow-200">
      <h2 className="text-3xl md:text-5xl font-bold text-center mb-12 text-black">Frequently Asked Questions</h2>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-sm text-zinc-600 mt-2">© 2026 Arunn Guptaa. All rights reserved.</p>
...
function StickyOfferBar({ timeLeft, format }) {
  return (
    ...
    >
      {/* Top block on Mobile (Price + Time on left, WhatsApp on right) | Left block on Desktop (Price + Time) */}
      <div className="flex justify-between items-center w-full sm:w-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-1 sm:gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-end gap-3">
              <span className="diag-strike text-lg text-zinc-500">₹39999</span>
              <span className="text-2xl font-extrabold text-yellow-600">₹7999</span>
            </div>
          </div>
        ...
        <a
          href="https://wa.me/919670111167?text=Hi,%20I%20have%20a%20query%20regarding%20the%201-on-1%20Business%20Guidance%20Session.%20Can%20you%20please%20help?"
          target="_blank"
          rel="noopener noreferrer"
          className="sm:hidden flex-shrink-0 hover:scale-110 transition-transform duration-300 drop-shadow-md ml-2 flex items-center justify-center"
          title="Chat with us on WhatsApp"
        >
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
            <path d="M16 0c-8.837 0-16 7.163-16 16 0 2.822.742 5.576 2.152 7.994L.462 30.686l6.837-1.794c2.32 1.284 4.939 1.96 7.643 1.96h.006c8.835 0 16-7.164 16-16S24.835 0 16 0z" fill="#25d366"/>
            <path d="M16 2.766c7.3 0 13.234 5.934 13.234 13.234S23.3 29.234 16 29.234c-2.333 0-4.63-.615-6.643-1.78l-.476-.276-4.934 1.294 1.314-4.811-.303-.482C3.81 21.2 3.167 18.665 3.167 16 3.167 8.7 9.1 2.766 16 2.766m0-2.766C7.164 0 0 7.163 0 16.001c0 2.82.742 5.576 2.152 7.994L.462 30.686l6.837-1.794c2.32 1.284 4.939 1.96 7.643 1.96h.006c8.835 0 16-7.164 16-16S24.835 0 16 0z" fill="#fff"/>
            <path d="M21.6 18.06c-.307-.153-1.815-.895-2.097-1-.283-.102-.49-.153-.697.153-.205.306-.793 1-.97 1.205-.18.204-.36.23-.667.077-1.956-.97-3.3-2.023-4.57-4.32-.13-.23-.014-.358.136-.51.136-.14.307-.358.46-.537.153-.18.205-.306.307-.51.103-.205.052-.383-.025-.537-.077-.154-.697-1.685-.953-2.308-.25-.595-.506-.515-.697-.525h-.595c-.23 0-.613.076-.946.434-.333.358-1.28 1.252-1.28 3.043 0 1.79 1.31 3.53 1.493 3.785.18.256 2.585 3.94 6.26 5.466.87.36 1.55.584 2.083.746.873.27 1.666.23 2.296.14.717-.1 1.814-.74 2.07-1.458.256-.716.256-1.33.18-1.458-.077-.128-.282-.205-.59-.358z" fill="#fff"/>
          </svg>
        </a>
      </div>

      {/* Bottom block on Mobile (Register Button) | Right block on Desktop (Register + WhatsApp) */}
      <div className="flex items-center justify-center gap-3 w-full sm:w-auto mt-2 sm:mt-0">
        <RegisterButton className={
          "px-6 py-2 sm:px-8 sm:py-3 text-sm sm:text-sm bg-gradient-to-r from-yellow-300 to-yellow-500 text-black font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition w-full sm:w-auto text-center justify-center flex"
        } />
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hidden sm:flex hover:scale-110 transition-transform duration-300 drop-shadow-md items-center justify-center"
          title="Chat with us on WhatsApp"
        >
